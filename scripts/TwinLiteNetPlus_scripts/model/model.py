...
class SingleLiteNetPlus(nn.Module):
    ...
    def __init__(self, args=None):
        ...
        self.caam = CAAM(
            feat_in=cfg.sc_ch_dict[args.config]["chanels"][2],
            num_classes=cfg.sc_ch_dict[args.config]["chanels"][2],
            bin_size=(2, 4),
            norm_layer=nn.BatchNorm2d,
        )
        self.conv_caam = ConvBatchnormRelu(
            cfg.sc_ch_dict[args.config]["chanels"][2],
            cfg.sc_ch_dict[args.config]["chanels"][1],
        )

        self.up_1 = UpConvBlock(
            cfg.sc_ch_dict[args.config]["chanels"][1],
            cfg.sc_ch_dict[args.config]["chanels"][0],
        )  # out: Hx4, Wx4
        self.up_2 = UpConvBlock(
            cfg.sc_ch_dict[args.config]["chanels"][0], 8
        )  # out: Hx2, Wx2
